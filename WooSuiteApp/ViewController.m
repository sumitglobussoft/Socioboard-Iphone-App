...
-(void)languageSelectAction{
   ...
   // BgView.backgroundColor=[[UIColor blackColor] colorWithAlphaComponent:0.6];
    ...
    languageView=[[UIView alloc]initWithFrame:CGRectMake(150*width1/320,50*height1/480, 160*width1/320,65*height1/480)];
    languageView.backgroundColor=[UIColor blackColor];
    ...
    LanguageSelect.alpha=.6;
    
    UIButton *englisgSelect=[UIButton buttonWithType:UIButtonTypeRoundedRect];
    englisgSelect.frame=CGRectMake(2*width1/320, 3*height1/480,156*width1/320, 30*height1/480);
    ...
    italic.frame=CGRectMake(2*width1/320, 34*height1/480,156*width1/320, 30*height1/480);
